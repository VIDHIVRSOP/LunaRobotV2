...
def stats(update: Update, context: CallbackContext):
    ...
    update.effective_message.reply_photo(SOFIA_STATSS, caption=result, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Owner✨", url="tg://user?id=5029525372"), InlineKeyboardButton(text="Support🧚‍♀️", url="https://t.me/SOFIASUPPORT"),],]), parse_mode=ParseMode.HTML)
